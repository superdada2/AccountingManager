...
CREATE TABLE invoice(
    ...
    invoiceAmount DECIMAL(10,3) NOT NULL,
    ...
    FXRate DECIMAL(10,3) NOT NULL DEFAULT 1,
    revenueType INT NOT NULL,
    cancellationDate DATETIME,
    annualIncreaseEli BIT NOT NULL DEFAULT 0,
    dateLastIncrease DATE,
    increasePercentage DECIMAL(10,3) DEFAULT 0,
    invoiceAmountUSD DECIMAL(10,3) NOT NULL,
    MonthlyRecoginitionAmountUSD DECIMAL(10,3) NOT NULL,
